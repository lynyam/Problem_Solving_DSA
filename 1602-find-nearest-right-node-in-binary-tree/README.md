<h2><a href="https://leetcode.com/problems/find-nearest-right-node-in-binary-tree/?envType=company&envId=google&favoriteSlug=google-all">1602. Find Nearest Right Node in Binary Tree</a></h2><h3>Medium</h3><hr><p>Given the <code>root</code> of a binary tree and a node <code>u</code> in the tree, return <em>the <strong>nearest</strong> node on the <strong>same level</strong> that is to the <strong>right</strong> of</em> <code>u</code><em>, or return</em> <code>null</code> <em>if </em><code>u</code> <em>is the rightmost node in its level</em>.</p>
